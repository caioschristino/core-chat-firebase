package com.v2.chat.ui.chat_groups.fragments;
...
import static com.v2.chat.ui.ChatUI.BUNDLE_RECIPIENT;
...
public class BottomSheetGroupAdminPanelMember extends BottomSheetDialogFragment {
    ...
    private void registerViews(View rootView) {
        ...
        removeMember.setOnClickListener(view -> showRemoveMemberAlertDialog());
        ...
        if (!groupMember.equals(loggedUser)) {
            ...
            seeProfile.setOnClickListener(view -> {
